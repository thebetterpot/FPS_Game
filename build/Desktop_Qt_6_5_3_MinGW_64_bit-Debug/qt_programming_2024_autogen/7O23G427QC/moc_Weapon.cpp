...
Q_CONSTINIT static const qt_meta_stringdata_CLASSWeaponENDCLASS_t qt_meta_stringdata_CLASSWeaponENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 6),  // "attack"
        QT_MOC_LITERAL(14, 0),  // ""
        QT_MOC_LITERAL(15, 10),  // "WeaponType"
        QT_MOC_LITERAL(26, 4),  // "type"
        QT_MOC_LITERAL(31, 8),  // "position"
        QT_MOC_LITERAL(40, 9),  // "direction"
        QT_MOC_LITERAL(50, 14)   // "updateCooldown"
    },
    "Weapon",
    "attack",
    "",
...
void Weapon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->attack((*reinterpret_cast< std::add_pointer_t<WeaponType>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<qreal>>(_a[3]))); break;
        case 1: _t->updateCooldown(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Weapon::*)(WeaponType , QPointF , qreal );
            if (_t _q_method = &Weapon::attack; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Weapon::attack(WeaponType _t1, QPointF _t2, qreal _t3)
{
